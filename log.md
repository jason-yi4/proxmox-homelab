...
* Adjusted wording of the [README.md](README.md) file to mention that a third VM is needed to run the VPN for outside access. Admittedly, I did not know that the VPN would require its own VM or container, but a clarification was made after researching.
